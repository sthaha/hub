...
func handleHTTPServer(ctx context.Context, u *url.URL, resourceEndpoints *resource.Endpoints, categoryEndpoints *category.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
